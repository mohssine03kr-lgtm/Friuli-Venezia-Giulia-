...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-6 glass backdrop-blur-lg border-b border-white/10">
      ...
      <button className="px-6 py-2 border border-[#C5A059] text-[#C5A059] rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#C5A059] hover:text-[#002B2B] transition-all">
        Membership
      </button>
    </nav>
  );
